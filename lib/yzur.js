...
const YZUR = {
  ...
  Roll: {
    baseTemplate: '/systems/invincible/templates/dice/broll.hbs',
    chatTemplate: "/systems/invincible/templates/dice/roll.hbs",
    tooltipTemplate: "/systems/invincible/templates/dice/tooltip.hbs",
    infosTemplate: "/systems/invincible/templates/dice/infos.hbs",
  },
  Dice: {
  ...
  Icons: {
    ...
    inv: {
      base: {
        '1': '<img src="systems/invincible/assets/dice/base-1.webp" width="36" />',
        '2': `<img src="systems/invincible/assets/dice/base-2.webp" width="36" />`,
        '3': `<img src="systems/invincible/assets/dice/base-3.webp" width="36" />`,
        '4': `<img src="systems/invincible/assets/dice/base-4.webp" width="36" />`,
        '5': `<img src="systems/invincible/assets/dice/base-5.webp" width="36" />`,
        '6': `<img src="systems/invincible/assets/dice/base-6.webp" width="36" />`,
      }
    },
    cgd: {
      base: {
        '1': '<img src="systems/coriolis-tgd/assets/dice/base-1.webp" width="36" />',
        '2': `<img src="systems/coriolis-tgd/assets/dice/base-2.webp" width="36" />`,
        '3': `<img src="systems/coriolis-tgd/assets/dice/base-3.webp" width="36" />`,
        '4': `<img src="systems/coriolis-tgd/assets/dice/base-4.webp" width="36" />`,
        '5': `<img src="systems/coriolis-tgd/assets/dice/base-5.webp" width="36" />`,
        '6': `<img src="systems/coriolis-tgd/assets/dice/base-6.webp" width="36" />`,
      },
      gear: {
        '1': `<img src="systems/coriolis-tgd/assets/dice/gear-1.webp" width="36" />`,
        '2': `<img src="systems/coriolis-tgd/assets/dice/gear-2.webp" width="36" />`,
        '3': `<img src="systems/coriolis-tgd/assets/dice/gear-3.webp" width="36" />`,
        '4': `<img src="systems/coriolis-tgd/assets/dice/gear-4.webp" width="36" />`,
        '5': `<img src="systems/coriolis-tgd/assets/dice/gear-5.webp" width="36" />`,
        '6': `<img src="systems/coriolis-tgd/assets/dice/gear-6.webp" width="36" />`,
      },
    },
    fbl: {
      base: {
...
class YearZeroRoll extends Roll {
   ...
   */
  get attackDamage() {
    if (!this.options.damage) return undefined;
    return this.options.damage + this.successCount - 1;
  }

  get stunts() {
    if (this.successCount == 0 || !this.attackDamage) return undefined;
    return this.successCount - 1;
  }

  get canApplyDamage() {
    return !this.pushable && (this.successCount == 1 || this.options.stuntsList?.length > 0) && this.attackDamage > 0;
  }

  get isSimpleRoll() {
    return !this.terms.some(t => t instanceof BaseDie || t instanceof SkillDie || t instanceof GearDie);
  }
  ...
  async modify(mod = 0) {
    ...
    // --------------------------------------------
    else if (['myz', 'fbl', 'alien', 'cgd'].includes(this.game)) {
  ...
  async toMessage(messageData = {}, { rollMode = null, create = true } = {}) {
    messageData = foundry.utils.mergeObject({
      ...
      //THIS applies directly in v12 removing it has no effect
      type: this.rolls,
