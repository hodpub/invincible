...
export default class InvincibleVehicleWeapon extends InvincibleItemBase {
  static LOCALIZATION_PREFIXES = [
    'INVINCIBLE.Item.base',
    'INVINCIBLE.Item.VehicleWeapon',
  ];
  ...
  static defineSchema() {
    ...
    schema.restricted = new fields.BooleanField({ initial: true });
